...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (result?.error) {
        if (result.error === "TENANT_SUSPENDED") {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">PhidPOS</h1>
            <p className="text-gray-500 text-sm mt-1">Multi-Tenant Retail POS System</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-sm pr-10"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg text-xs text-gray-600">
            ...
            <p>Admin: admin@demo-shop.com / Admin@1234</p>
            <p>Cashier: cashier@demo-shop.com / Cashier@1234</p>
          </div>
        </div>
